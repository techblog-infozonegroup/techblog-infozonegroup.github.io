...
- **CQS handlar om att separera ansvar** och inte försätta sig i svårbemästrade beroenden. När en funktion i ett system "färdig", det vill säga implementerad, testad och produktionssatt, så ska **en ny funktion inte kunna förstöra den redan färdiga funktionen**.
